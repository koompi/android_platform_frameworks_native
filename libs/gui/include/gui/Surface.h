...
public:
    ...
    status_t getCompositorTiming(nsecs_t* compositeDeadline, nsecs_t* compositeInterval,
                                 nsecs_t* compositeToPresentLatency);

    // See IGraphicBufferProducer::getFrameTimestamps
    status_t getFrameTimestamps(uint64_t frameNumber, nsecs_t* outRequestedPresentTime,
                                nsecs_t* outAcquireTime, nsecs_t* outLatchTime,
                                nsecs_t* outFirstRefreshStartTime, nsecs_t* outLastRefreshStartTime,
                                nsecs_t* outGlCompositionDoneTime, nsecs_t* outDisplayPresentTime,
...
public:
    ...
    virtual int connect(int api, const sp<IProducerListener>& listener, bool reportBufferRemoval);
    ...
    virtual int lockWithHandle(ANativeWindow_Buffer* outBuffer, buffer_handle_t* handle,
